...
class CreateVendaProdutosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            ...
            $table->integer('produtos_idprodutos');
            $table->timestamps();

            $table->index(["produtos_idprodutos"], 'fk_venda_produtos_produtos1_idx');
            ...
            $table->foreign('produtos_idprodutos', 'fk_venda_produtos_produtos1_idx')
